...
Pod::Spec.new do |s|
  s.name         = "Reader17k" # 项目名称
  s.version      = "1.1.1"        # 版本号 与 仓库的 标签号 对应
  s.license      = { :type => "MIT", :file => "LICENSE" }          # 开源证书
  s.summary      = "17k听读一体SDK" # 项目简介
  s.homepage     = "https://gitlab.com/ZM_iOS/project/reader17ksdk" # 仓库的主页
  s.source       = { :git => "https://gitlab.com/ZM_iOS/project/reader17ksdk.git", :tag => "#{s.version}" }
  #s.source_files = 'Classes/*','Classes/**/*'
  s.vendored_frameworks = 'Reader17k/*.xcframework'
